...
{
    [TestClass]
    public class PickerFlyoutPresenterDerivationTests : XamlTestsBase
    {
        private sealed class DerivedPickerFlyoutPresenter : XamlControls.PickerFlyoutPresenter
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedPickerFlyoutPresenter();
            });
        }
    }
}
