...
{
    [TestClass]
    public class LoopingSelectorPanelDerivationTests : XamlTestsBase
    {
        private sealed class DerivedLoopingSelectorPanel : XamlControls.LoopingSelectorPanel
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedLoopingSelectorPanel();
            });
        }
    }
}
