...
{
    [TestClass]
    public class HubSectionCollectionDerivationTests : XamlTestsBase
    {
        private sealed class DerivedHubSectionCollection : XamlControls.HubSectionCollection
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedHubSectionCollection();
            });
        }
    }
}
