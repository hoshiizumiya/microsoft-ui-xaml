...
{
    [TestClass]
    public class LoopingSelectorDerivationTests : XamlTestsBase
    {
        private sealed class DerivedLoopingSelector : XamlControls.LoopingSelector
        {
        }
