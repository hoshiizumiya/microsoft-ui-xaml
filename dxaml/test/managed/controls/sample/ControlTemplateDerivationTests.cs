...
{
    [TestClass]
    public class ControlTemplateDerivationTests : XamlTestsBase
    {
        private sealed class DerivedControlTemplate : XamlControls.ControlTemplate
        {
        }
