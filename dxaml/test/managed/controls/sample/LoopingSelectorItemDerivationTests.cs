...
{
    [TestClass]
    public class LoopingSelectorItemDerivationTests : XamlTestsBase
    {
        private sealed class DerivedLoopingSelectorItem : XamlControls.LoopingSelectorItem
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedLoopingSelectorItem();
            });
        }
    }
}
