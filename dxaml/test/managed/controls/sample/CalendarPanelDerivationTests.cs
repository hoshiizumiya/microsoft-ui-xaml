...
{
    [TestClass]
    public class CalendarPanelDerivationTests : XamlTestsBase
    {
        private sealed class DerivedCalendarPanel : XamlPrimitives.CalendarPanel
        {
        }
