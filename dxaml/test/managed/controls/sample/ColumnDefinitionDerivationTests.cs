...
{
    [TestClass]
    public class ColumnDefinitionDerivationTests : XamlTestsBase
    {
        private sealed class DerivedColumnDefinition : XamlControls.ColumnDefinition
        {
        }
